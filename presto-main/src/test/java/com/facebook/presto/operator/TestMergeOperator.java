...
public class TestMergeOperator
{
    ...
    public void setUp()
    {
        ...
        exchangeClientFactory = new ExchangeClientFactory(new ExchangeClientConfig(), new TaskManagerConfig(), httpClient, new TestingDriftClient<>(), executor, new QueryManagerConfig(), null, null, null, statusNotificationManager, exchangeClientStats);
