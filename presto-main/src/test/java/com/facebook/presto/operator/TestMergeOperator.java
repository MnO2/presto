...
public class TestMergeOperator
{
    ...
    {
        return new Split(ExchangeOperator.REMOTE_CONNECTOR_ID, new RemoteTransactionHandle(), new RemoteSplit(new Location("http://localhost/" + taskId, false), TaskId.valueOf(taskId)));
    }
