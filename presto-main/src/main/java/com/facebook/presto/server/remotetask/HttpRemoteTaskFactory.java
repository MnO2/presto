        ...
        implements RemoteTaskFactory
{
            ...
            ConnectorTypeSerdeManager connectorTypeSerdeManager)
    {
        ...
        binaryTransportEnabled = false; //communicationConfig.isBinaryTransportEnabled();
        thriftTransportEnabled = false; //communicationConfig.isThriftTransportEnabled();
        taskInfoThriftTransportEnabled = false; //communicationConfig.isTaskInfoThriftTransportEnabled();
